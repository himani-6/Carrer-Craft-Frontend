...
const SignUp = () => {
  ...
  const handleAppleSignIn = () => {
    alert(
      "Apple Sign-In is currently not available. Please use Google or Email instead."
    );
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      >
        ...
        <input
          ...
          onChange={handleChange}
          className="w-full p-3 mb-6 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-gray-400"
          required
        />
